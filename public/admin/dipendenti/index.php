...
if (isset($_GET['delete'])) {
    $dipendenteModel->delete((int)$_GET['delete']);
...
$reparti = [];
foreach ($dipendenteModel->all() as $d) {
...
<head>
    ...
    <style>
        .filters { display:grid; grid-template-columns:2fr 1fr auto; gap:.75rem; background:#fff; border:1px solid var(--gray-200); border-radius:12px; padding:1rem; margin-bottom:1rem; }
        ...
        <table class="data-table">
            ...
            <?php foreach ($dipendenti as $d): ?>
                <tr>
                    ...
                    <td class="actions">
                        <a href="modifica.php?id=<?= (int)$d['id_dipendente'] ?>" class="btn btn-warning">Modifica</a>
                        <a href="index.php?delete=<?= (int)$d['id_dipendente'] ?>" class="btn btn-danger" onclick="return confirm('Eliminare questo dipendente?');">Elimina</a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
